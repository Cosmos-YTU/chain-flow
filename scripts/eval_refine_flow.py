"""Eval for the refine-flow drafter (V3): cached per-position accept@i (teacher-forced AR,
...
from chained_flow.training.train_refine_flow import load_refine_module
...
def main() -> None:
    ...
    module, config = load_refine_module(args.flow_dir, frozen_lm=frozen_lm, device=device)
    ...
    for i, batch in enumerate(loader):
        ...
        pred_hidden = drafter.forward_teacher(context_hidden, target_hidden, future_tokens)["pred_hidden"]
