...
from chained_flow.training.train_eagle_flow import EagleModelArguments, train_eagle_with_trainer


def main() -> None:
    parser = HfArgumentParser((EagleModelArguments, TeacherDataArguments, FlowLossArguments, TrainingArguments))
    ...
    result = train_eagle_with_trainer(model_args, data_args, loss_args, training_args)
    print(result)
