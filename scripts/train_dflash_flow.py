...
def main() -> None:
    parser = HfArgumentParser((DFlashModelArguments, TeacherDataArguments, FlowLossArguments, TrainingArguments))
    ...
    print(train_dflash_with_trainer(model_args, data_args, loss_args, training_args))
