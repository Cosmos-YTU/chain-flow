"""Eval for the EAGLE-style drafter (V2): cached per-position accept@i (teacher-forced AR,
...
def main() -> None:
    ...
    module, config = load_eagle_module(args.flow_dir, frozen_lm=frozen_lm, device=device)
    ...
    for i, batch in enumerate(loader):
        ...
        pred_hidden = drafter.forward_teacher(context_hidden, target_hidden, future_tokens)
