...
(`chained_flow/patches/vllm-0.25.1-chained-flow-tree.patch`): a tree-aware verify, a tree-shaped
...
class FlowDrafterProposer:
    ...
    def _build(self):
        ...
        if self.twopass_m >= self._hw.shape[0]:
            ...
            from chained_flow import defaults as _cfd0
        ...
        if self.twopass_m:
            print(f"[chained-flow] TWO-PASS candidate head ON: M={self.twopass_m} of "
