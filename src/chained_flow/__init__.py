...
Importing the package APPLIES THE CAPABILITY-GATED FLAG DEFAULTS (``chained_flow.defaults``)
...
THE PUBLIC NAMES ARE LAZY (PEP 562).  ``chained_flow.vllm_plugin.async_guard`` is a
...
from chained_flow import defaults as _cf_defaults
...
_LAZY = {
    "ChainedFlowContext": "chained_flow.context",
    "FrozenLMWrapper": "chained_flow.frozen_lm",
    "LMState": "chained_flow.frozen_lm",
    "GenerationResult": "chained_flow.generation",
    "generate_with_drafter": "chained_flow.generation",
}
