...
def train_dflash_with_trainer(
    ...
    with (output_dir / "chain_flow_dflash_config.json").open("w", encoding="utf-8") as f:
        json.dump(
...
def load_dflash_module(flow_dir: str | Path, *, frozen_lm: FrozenLMWrapper, device) -> tuple[DFlashTrainingModule, dict[str, Any]]:
    ...
    config_path = flow_dir / "chain_flow_dflash_config.json"
    if not config_path.exists():
        config_path = flow_dir.parent / "chain_flow_dflash_config.json"
