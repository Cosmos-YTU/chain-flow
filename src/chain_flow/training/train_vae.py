...
from chain_flow.training.vae_dataset import TeacherHiddenSequenceDataset, TeacherHiddenTokenDataset, collate_hidden_tokens
from chain_flow.training.vae_losses import HiddenVAELossConfig, compute_hidden_vae_loss
...
def train_vae_with_trainer(
    ...
    with (output_dir / "chain_flow_vae_config.json").open("w", encoding="utf-8") as f:
        json.dump(
            {
