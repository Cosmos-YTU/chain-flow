...
from chain_flow.drafters.chunked_flow import SingleExpertFlowConfig, SingleExpertFlowDrafter
...
def train_chunked_flow_with_trainer(
    ...
    with (output_dir / "chain_flow_chunked_flow_config.json").open("w", encoding="utf-8") as f:
        json.dump(
            {
