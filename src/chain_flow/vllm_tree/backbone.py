...
class TreeBackbone:
    ...
    def tree_verify(self, st: dict, node_tokens, parent, depth) -> torch.Tensor:
        ...
        from chain_flow.vllm_tree.tree_ssm import tree_gated_delta_recurrence, tree_causal_conv1d
        w = self.w
        N = len(node_tokens)
        dev = self.dev
    ...
    def _verify_body(self):
        from chain_flow.vllm_tree.tree_ssm import tree_gdn_op as _tgd, tree_conv_op as _tcv
