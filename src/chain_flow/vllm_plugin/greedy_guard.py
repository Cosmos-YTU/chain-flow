...
* Never raises out of `install()`: this runs in every vLLM process that has chain-flow
...
_MSG = (
    "chain-flow TREE speculative decoding requires greedy sampling: "
...
def _sampled_nospec() -> bool:
    ...
    try:
        from chain_flow.vllm_plugin import tree_sampling
