...
CKD = "/home/shadeform/chained-flow/out/flow/ckpts/tree-vae-joint-9b-1024-k8-l8"
...
llm = LLM(model=MODEL, gpu_memory_utilization=0.65, max_model_len=2048, dtype="float16", enforce_eager=False)
